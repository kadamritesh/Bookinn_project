<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pay_method.aspx.cs" Inherits="BookInn.Admin_Master.Pay_method" %>
                    ...
                    <div class="card p-3">
                        <div class="card-body border p-0">
                            ...
                            <div class="collapse p-3 pt-0" id="paypalCollapse">
                                <div class="row">
                                    <div class="col-8">
                                        <p class="h4 mb-0">Subcription</p>
                                        <p class="mb-0">
                                            <span class="fw-bold">Pay:</span><span class="c-green"> Bookinn Company</span>
                                        </p>
                                        <p class="mb-0">
                                            <span class="fw-bold">Price:</span><span
                                                class="c-green">50,000.00</span>
                                        </p>
                                        <div style="font-family: 'Arial Black', sans-serif; font-size: 14px; color: #333;">
                                            <p class="mb-0">

                                                <strong>Unlock</strong> the power to elevate your hotel's online presence with our <strong>premium subscription service</strong>, tailor-made for discerning administrators like you. Dive into <em>seamless efficiency</em> as you effortlessly integrate your hotel's details into our <strong>cutting-edge booking system</strong>. Our subscription not only streamlines the process of adding and managing hotel details but also ensures <strong>maximum visibility and reach</strong>. Embrace innovation and stay ahead of the curve with <strong>Bookinn Company's subscription service</strong>.                                            
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 mb-lg-0 mb-3">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <span class="c-green">:50,000.00</span>
                                        </p>
                                        <div style="font-family: 'Arial Black', sans-serif; font-size: 14px; color: #333;">
                                            <p class="mb-0">

                                                <strong>Revolutionize</strong> your hotel's online presence and <strong>skyrocket</strong> your bookings with <strong>Bookinn Company's exclusive subscription service</strong>.                                            
                                            </p>
                                        </div>
