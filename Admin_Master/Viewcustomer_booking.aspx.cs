...
{
    public partial class Viewcustomer_booking : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                BindBookingDataByHotelID(hotelID);
            }
        }
        private void BindBookingDataByHotelID(int hotelID)
        {
            ...
            string query = "SELECT * FROM Booking_table WHERE hotel_ID = @HotelID";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    customerbooking_data.DataSource = dataTable;
                    customerbooking_data.DataBind();
                }
            }
        }
    }
