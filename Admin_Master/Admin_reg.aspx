<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_reg.aspx.cs" Inherits="BookInn.Admin_reg" %>
				...
				<form id="form1" runat="server">
					...
					<div class="form-group">
						<div class="form-wrapper">
							...
							<div class="form-holder">
								...
								<asp:TextBox ID="user_txt"  class="form-control" runat="server"></asp:TextBox>

								

							</div>
							<asp:Label ID="user_lb" runat="server" CssClass="error-message" ForeColor="Red" Text=""></asp:Label>
						</div>
                        <div class="form-wrapper">
                            ...
                            <asp:Label ID="fname_lb" runat="server" CssClass="error-message" ForeColor="Red" Text=""></asp:Label>
                        </div>
                        ...
                        <div class="form-wrapper">
                            ...
                            <asp:Label ID="lname_lb" runat="server" CssClass="error-message" ForeColor="Red" Text=""></asp:Label>
                        </div>
					</div>
					<div class="form-group">
                        <div class="form-wrapper">
                            ...
                            <asp:Label ID="email_lb" runat="server" CssClass="error-message" ForeColor="Red" Text=""></asp:Label>
                        </div>
                        <div class="form-wrapper">
                            ...
                            <asp:Label ID="birthdate_lb" runat="server" Visible="false" ForeColor="Red"></asp:Label>
					...
					<div class="form-group">
						<div class="form-wrapper">
							...
							<asp:Label ID="pass_lb" runat="server" CssClass="error-message" ForeColor="Red" Text=""></asp:Label>
						</div>
						<div class="form-wrapper">
							...
							<asp:Label ID="confirmpass_lb" runat="server" CssClass="error-message" ForeColor="Red" Text="" ></asp:Label>
					...
					<div class="form-group">
						<div class="form-wrapper">
							...
							<asp:Label ID="contact_lb" runat="server" CssClass="error-message" ForeColor="Red" Text=""></asp:Label>
						</div>
                        <div class="form-wrapper">
                            ...
                            <div class="form-holder">
                                ...
                                <asp:TextBox ID="location_txt" runat="server" Class="form-control"></asp:TextBox>
                            </div>
                            <asp:Label ID="location_lb" runat="server" CssClass="error-message" ForeColor="Red" Text=""></asp:Label>
                        </div>
						<div class="form-wrapper">
