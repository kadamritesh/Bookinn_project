<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wizard_page.aspx.cs" Inherits="BookInn.wizard_page"  %>
            ...
            <div class="col-md-4">
                ...
                <div class="card  bg-white shadow p-5">
                    ...
                    <div class="text-center">
                        ...
                        <asp:Button ID="success_button" CssClass="btn btn-outline-success"  runat="server" Text="Continue" />
                    </div>
                </div>
            </div>
        </div>
